...
const JobSchema = new mongoose.Schema({
    company: { type: String, required: [true, 'Provide company'], maxlength: 50, },
    position: { type: String, required: [true, 'Provide company'], maxlength: 100, },
    ...
    jobLocation: { type: String, default: 'Mangalore', required: true, },
